...
public class ItemBuilder {
    ...
    public ItemBuilder setTag(String key, String value) {
        item = SpectatorOptions.getInstance().getBedWars().getVersionSupport().setTag(item, key, value);
        return this;
    }
    ...
    public static String getTag(ItemStack item, String key) {
        String tag = SpectatorOptions.getInstance().getBedWars().getVersionSupport().getTag(item, key);
        return tag == null ? "" : tag;
    }
